...
import org.classmaker.provider.ClassMakerItemProviderAdapterFactory;
...
public class ClassMakerEditor
			...
			public void partActivated(IWorkbenchPart p) {
				if (p instanceof ContentOutline) {
					if (((ContentOutline)p).getCurrentPage() == contentOutlinePage) {
						getActionBarContributor().setActiveEditor(ClassMakerEditor.this);
				...
				else if (p == ClassMakerEditor.this) {
					handleActivate();
				}
			}
	...
	protected void handleActivate() {
		...
		if (!removedResources.isEmpty()) {
			if (handleDirtyConflict()) {
				getSite().getPage().closeEditor(ClassMakerEditor.this, false);
			}
			else {
	...
	protected void initializeEditingDomain() {
		...
		adapterFactory.addAdapterFactory(new ClassMakerItemProviderAdapterFactory());
		...
		if (!getEditingDomain().getResourceSet().getResources().isEmpty()) {
			...
			//
			{
				ViewerPane viewerPane =
					new ViewerPane(getSite().getPage(), ClassMakerEditor.this) {
						@Override
			...
			propertySheetPage =
				new ExtendedPropertySheetPage(editingDomain) {
					...
					public void setSelectionToViewer(List<?> selection) {
						...
						ClassMakerEditor.this.setFocus();
					}
	...
	private static String getString(String key) {
		return ClassMakerEditorPlugin.INSTANCE.getString(key);
	}
	...
	private static String getString(String key, Object s1) {
		return ClassMakerEditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
