 ...
 * @generated
 */
public class ClassMakerActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(ClassMakerEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(ClassMakerEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(ClassMakerEditorPlugin.INSTANCE.getString("_UI_ClassMakerEditor_menu"), "org.classmakerMenuID");
		...
		//
		createChildMenuManager = new MenuManager(ClassMakerEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(ClassMakerEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(ClassMakerEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildSubmenuActions, null);
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(ClassMakerEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
