/**
 */
package org.classmaker.provider;
...
/**
 * This is the item provider adapter for a {@link org.classmaker.Bundle} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BundleItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ClassMakerPackage.Literals.BUNDLE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDynamicEPackagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Bundle_dynamicEPackage_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Bundle_dynamicEPackage_feature", "_UI_Bundle_type"),
				 ClassMakerPackage.Literals.BUNDLE__DYNAMIC_EPACKAGE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Bundle_state_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Bundle_state_feature", "_UI_Bundle_type"),
				 ClassMakerPackage.Literals.BUNDLE__STATE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addStatusPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Bundle_status_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Bundle_status_feature", "_UI_Bundle_type"),
				 ClassMakerPackage.Literals.BUNDLE__STATUS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ClassMakerPackage.Literals.BUNDLE__EPACKAGE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ClassMakerPackage.Literals.BUNDLE__EPACKAGE,
