...
public class EClassPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, EClassPropertiesEditionPart {
		...
		instanceClassName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							EClassPropertiesEditionPartForm.this,
							EcoreViewsRepository.EClass.Properties.instanceClassName,
		...
		instanceTypeName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							EClassPropertiesEditionPartForm.this,
							EcoreViewsRepository.EClass.Properties.instanceTypeName,
	...
	protected Composite createAbstract_Checkbox(FormToolkit widgetFactory, Composite parent) {
		abstract_ = widgetFactory.createButton(parent, getDescription(EcoreViewsRepository.EClass.Properties.abstract_, EcoreMessages.EClassPropertiesEditionPart_Abstract_Label), SWT.CHECK);
	...
	protected Composite createInterface_Checkbox(FormToolkit widgetFactory, Composite parent) {
		interface_ = widgetFactory.createButton(parent, getDescription(EcoreViewsRepository.EClass.Properties.interface_, EcoreMessages.EClassPropertiesEditionPart_Interface_Label), SWT.CHECK);
	...
	protected Composite createESuperTypesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.eSuperTypes = new ReferencesTable(getDescription(EcoreViewsRepository.EClass.Properties.eSuperTypes, EcoreMessages.EClassPropertiesEditionPart_ESuperTypesLabel), new ReferencesTableListener	() {
