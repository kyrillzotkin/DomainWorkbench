 ...
 * 
 */
public class EEnumPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, EEnumPropertiesEditionPart {
	 ...
	 */
	public EEnumPropertiesEditionPartForm() { super(); }
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							EEnumPropertiesEditionPartForm.this,
							EcoreViewsRepository.EEnum.Properties.name,
		...
		instanceClassName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							EEnumPropertiesEditionPartForm.this,
							EcoreViewsRepository.EEnum.Properties.instanceClassName,
		...
		instanceTypeName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							EEnumPropertiesEditionPartForm.this,
							EcoreViewsRepository.EEnum.Properties.instanceTypeName,
	...
	protected Composite createSerializableCheckbox(FormToolkit widgetFactory, Composite parent) {
		serializable = widgetFactory.createButton(parent, getDescription(EcoreViewsRepository.EEnum.Properties.serializable, EcoreMessages.EEnumPropertiesEditionPart_SerializableLabel), SWT.CHECK);
