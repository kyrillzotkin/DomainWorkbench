...
public class ETypeComboViewerSWTRendererService implements EMFFormsDIRendererService<VControl> {
	...
	public double isApplicable(VElement vElement, ViewModelContext viewModelContext) {
		...
		if (!EcorePackage.eINSTANCE.getETypedElement_EType().equals(eStructuralFeature)) {
			return NOT_APPLICABLE;
		}
		return 3d;		
	}
	...
	public Class<? extends AbstractSWTRenderer<VControl>> getRendererClass() {
		return ETypeComboViewerSWTRenderer.class;
	}
